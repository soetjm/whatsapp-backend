...
export const create_open_conversation = async (req, res, next) => {
  console.log("http://localhost:8000/api/v1/conversation/",req.body);
  try {
    ...
    /**
     * @imprtant isGroup is Change to undefined
     */
    if (isGroup == undefined || isGroup == false) {
      ...
      if (existed_conversation) {
        ...
        let convoData = {
          /**
           * @imprtant subistitute conversation anem with reciver.name 
           */
